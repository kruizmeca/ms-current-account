...
//hi
    WebClient webClientCustomer = WebClient.create("http://servicio-zuul-server:9090/ms-customer/customer");

    WebClient webClientCreditCard = WebClient.create("http://servicio-zuul-server:9090/ms-creditcard/creditcard");
